...
\begin{multicols}{2}
\lettrine[nindent=0em,lines=3]{P}rotože tato zpráva vznikla jako shrnutí několika různých textů, které se věnují různým aspektům problematiky, rozdělil jsem ji do kapitol odpovídajících daným zdrojům. Každá kapitola je tedy shrnutím jednoho či více zdrojů, s dodatečnými informacemi a zdroji. V případě, že jsem neměl možnost nějaké tvrzení ověřit, např. pro nedostupnost původního materiálu, tuto skutečnost poznačuji.

Open-source je v textu, není-li řečeno jinak, chápán ve smyslu definovaném Open Source Initiative~\cite{OSI-2011}, tedy zkráceně svobodný přístup, distribuce a modifikace.\todo{Some opening, more about used sources...}
